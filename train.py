...
if __name__ == '__main__':
    ...
    print('The number of validating images = %d' % dataset_size_val)
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
        ...
        for key in model.metrics_names:
            metrics_total[key] /= dataset_size_val
            
        visualizer.plot_current_losses(epoch, 0, metrics_total)
        visualizer.print_val_metrics(epoch, metrics_total)
